...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-514) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Sample Problem:
...
;; ex-514
;; Make up an ISL+ expression in which x occurs both free
;; and bound. Formulate it as an element of Lam. 

(define test '((λ (x) x) x))

;; identity app where x is bound in λ fun and free in arg
;;
;; Q: Does undeclareds work properly on your expression?
;; A: (undeclareds test) -> '((λ (x) x) *undeclared)
;; works as properly.

...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-321-undone) (read-case-sensitive #true) (teachpacks ()) (htdp-settings #(#true constructor repeating-decimal #false #true none #false () #false)))
;; ex-321
...
; An [Atomic X] is a non-compound value.
; where X is the value:
;   Number
;   String
;   Symbol
(define atomic-number 0)
(define atomic-string "a")
(define atomic-symbol 'a)

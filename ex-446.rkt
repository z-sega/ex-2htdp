...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-446) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; ex-446
;; Add the test from ex-445 to the program in
;; fig-159. Experiment with different values for
;; EPSILON

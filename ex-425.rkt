...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-425) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; ex-425
;; Articulate purpose statements for smallers and
;; largers in fig-149.

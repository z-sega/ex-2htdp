...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname generative-recursion-binary-search) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

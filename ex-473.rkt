...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-473) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; ex-473
;; Test find-path on 'B, 'C, and the graph in fig-170. Also use
;; test-on-all-nodes from ex-472 on this graph.

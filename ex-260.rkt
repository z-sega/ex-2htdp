...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname ex-260) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; ex-260
;; Confirm the insight about the performance of inf.v2 by
;; repeating the performance experiment of ex-238.

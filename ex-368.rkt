...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-368) (read-case-sensitive #true) (teachpacks ()) (htdp-settings #(#true constructor repeating-decimal #false #true none #false () #false)))
...
;; ex-368
;; Formulate a data definition that replaces the informal
;; "or" signature for the definition of the list-of-attributes?
;; function.

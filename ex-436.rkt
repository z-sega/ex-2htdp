...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-436) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; ex-436
;; Formulate a termination argument for food-create
;; from ex-432.

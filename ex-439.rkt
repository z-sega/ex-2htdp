...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex-439) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; N[>= 1] N[>= 1] -> N
